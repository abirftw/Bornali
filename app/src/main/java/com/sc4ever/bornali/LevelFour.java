...
public class LevelFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blankImg = (ImageView)  findViewById(R.id.yellowFishLevelFour);
        ...
        vv = (ViewGroup) findViewById(R.id.levelFourPage);
        img = (ImageView)  vv.findViewById(R.id.mainFishLevelfour);
        ...
        levelWinImg = (ImageView) findViewById(R.id.levelfourwinimage);
        levelWinText = (TextView) findViewById(R.id.levelfourwintext);
        buttonNextLevel = (Button) findViewById(R.id.nextlevelfourbutton);
        ...
        img.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                {
                    blankImg.setImageResource(R.drawable.fish);
                    img.setImageDrawable(null);
                    levelWinImg.setImageResource(R.drawable.levelwin);
                    Anim = AnimationUtils.loadAnimation(LevelFour.this,R.anim.levelwinanimtext);
